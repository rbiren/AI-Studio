...
export const IconComponents = {
  ...
  Logo: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M10.4,4.2C10.1,4,9.9,4,9.7,4.2L5.8,8.1C5.6,8.3,5.6,8.7,5.8,8.9l3.9,3.9c0.2,0.2,0.5,0.2,0.7,0l3.9-3.9 c0.2-0.2,0.2-0.5,0-0.7L10.4,4.2z M9.1,8.5L8,9.6l-1-1l1-1c0.2-0.2,0.5-0.2,0.7,0l0.4,0.4C9.3,8,9.3,8.3,9.1,8.5z M10.4,9.8 l-1.3-1.3l1.8-1.8l1.3,1.3L10.4,9.8z M18.2,12.8L14.3,8.9c-0.2-0.2-0.5-0.2-0.7,0l-3.9,3.9c-0.2,0.2-0.2,0.5,0,0.7l3.9,3.9 c0.2,0.2,0.5,0.2,0.7,0l3.9-3.9C18.4,13.3,18.4,13,18.2,12.8z"/></svg>
  ),
  ...
  Wand: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15 4V2"/><path d="M15 10V8"/><path d="M12.5 7H17.5"/><path d="M15 22v-4.5"/><path d="m12.5 19.5 5-5"/><path d="m17.5 12.5-5 5"/><path d="M3 21h12"/><path d="M17.5 4.5a2.5 2.5 0 0 1 0 5h-15a2.5 2.5 0 0 1 0-5Z"/></svg>
  )
};
